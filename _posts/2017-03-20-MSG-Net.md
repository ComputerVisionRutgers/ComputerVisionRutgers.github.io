...
<div  id="people" >
			<div>
				<iframe width="356" height="200" src="https://www.youtube.com/embed/l1KXmXS8oXU?ecver=1" frameborder="0" allowfullscreen></iframe>
			</div>
			<div></div>
			<div></div>
			<div>
...
<table width="100%" border="0" cellspacing="15" cellpadding="0">
	<tbody>
		<tr>
			<td width="356">
			<p>ArXiv Preprint [PDF](https://arxiv.org/pdf/1703.06953.pdf)</p>
			<p>Our code is available on [Github](https://github.com/zhanghang1989/MSG-Net), including:</p>
			<ul>
