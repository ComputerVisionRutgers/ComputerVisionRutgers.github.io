...
@article{zhang2016deep,
	...
	year={2016}
			...
			<tr><td width="25%" valign="top">
				<a><img src="http://hangzh.com/figure/xue17.svg" alt="xue17" width="260px" height="120px" style="border-style: none"></a>
			</td>
			<td width="75%" valign="top">
			<p>
...
@article{xue2016differential,
	...
	year={2016}
			...
			<!-- paper ECCV16 -->
			<tr><td width="25%" valign="top">
				<a><img src="http://hangzh.com/figure/eccv16.png" alt="zhang16" width="260px" height="120px" style="border-style: none"></a>
			</td>
			<td width="75%" valign="top">
			<p>
...
@inproceedings{zhang2016friction,
	...
	organization={Springer}
			...
			<!-- paper CVPR15 -->
			<tr><td width="25%" valign="top">
				<a><img src="http://hangzh.com/figure/cvpr15.svg" alt="zhang15" width="260px" height="120px" style="border-style: none"></a>
			</td>
			<td width="75%" valign="top">
			<p>
...
Created by <a href="http://hangzh.com">Hang Zhang</a>.
